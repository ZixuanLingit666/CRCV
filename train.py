...
from CRCV.models.cm import ClusterMemory
from CRCV.trainers import ClusterContrastTrainer
from CRCV.evaluators import Evaluator, extract_features
from CRCV.utils.data import IterLoader
from CRCV.utils.data import transforms as T
from CRCV.utils.data.sampler import RandomMultipleGallerySampler
...
# from CRCV.utils.faiss_rerank import compute_jaccard_distance
from CRCV.re_ranking import re_ranking
...
def main_worker(args):
    ...
    cam_labels = torch.tensor([cid for _, _, cid in sorted(dataset.train)])
    ...
    for epoch in range(args.epochs):
        with torch.no_grad():
            ...
            rerank_dist = re_ranking(features, cam_labels, num_cams, args.use_cam, k1=args.k1, k2=args.k2)
        ...
        def generate_cluster_features(labels, features):
            ...
            for i, label in enumerate(labels):
                if label == -1:     # filtering out outliers
                    continue
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="CRCV")

    # data
    parser.add_argument('-d', '--dataset', type=str, default='market1501',
                        choices=['market1501', 'dukemtmc-reid', 'msmt17'])
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default="./logs/market1501/sota")
                        
    parser.add_argument('--pooling-type', type=str, default='avg', choices=["avg", "gem"])
    # baseline or CRCV
    parser.add_argument("--use_cam", type=bool, default=True)
